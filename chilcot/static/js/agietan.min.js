...
$("#"+parent_id+".dropdown-toggle").dropdown("toggle");});$('.nav-link').on('click',function(){window.location.href=this.href;$('.navbar-collapse').removeClass('in');return false});function getParameterByName(name,url){if(!url)url=window.location.href;name=name.replace(/[\[\]]/g,"\\$&");var regex=new RegExp("[?&]"+name+"(=([^&#]*)|&|#|$)"),results=regex.exec(url);if(!results)return null;if(!results[2])return'';return decodeURIComponent(results[2].replace(/\+/g," "));}
